...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-Development.mk dist/${CND_CONF}/${IMAGE_TYPE}/CineFluxOrbit.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
